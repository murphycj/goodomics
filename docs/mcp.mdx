...
description: "Expose Goodomics tools and resources to MCP clients."
---

# MCP integration

MCP routes remain separated under `/mcp/*` while API routes use `/api/v1/*` and dashboard routes fall back to React routing.
