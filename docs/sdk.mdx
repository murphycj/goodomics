---
title: "Python SDK"
description: "Use the Goodomics Python SDK to log runs, samples, metrics, and artifacts."
---

# Python SDK

Import `run` from `goodomics`, create a run context, and record metrics without taking a dependency on the optional server package.
