...
The dashboard is a Vite React TypeScript app under `packages/goodomics-server/dashboard` and builds into `goodomics_server/web/static` for FastAPI to serve.
