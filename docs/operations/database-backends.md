...
durable control database when needed.

## SQLite

SQLite is the default control store for local product and project metadata.
...
!!! note "Analytical storage"
    The control database stores product metadata. DuckDB remains the default
