---
title: "Deployment"
description: "Build and deploy the Goodomics server container."
---

# Deployment

The server Dockerfile uses a Node stage to build the dashboard and a Python stage to install and run `goodomics-server serve --host 0.0.0.0 --port 8000`.
