---
title: "Goodomics documentation"
description: "Open-source Goodomics documentation for CLI, SDK, server, dashboard, and deployment."
---

# Goodomics documentation

Use these portable MDX files as the docs source for the Astro marketing site. The site can copy, sync, subtree, or submodule this directory into an Astro `docs` content collection and render it at `/docs/*` with a sidebar layout.
