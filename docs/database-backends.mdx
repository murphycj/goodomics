...
description: "Configure SQLite, Postgres, or MySQL storage URLs."
---

# Database backends

Supported URLs include `sqlite+aiosqlite:///./goodomics.db`, `postgresql+psycopg://localhost/goodomics`, and `mysql+aiomysql://localhost/goodomics`.
